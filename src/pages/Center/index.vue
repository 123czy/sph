        ...
        <div class="order-right">
          <div class="order-content">
            ...
            <div class="orders">
              ...
              <table class="order-item" v-for=" record in orderInfo.records" :key="record.id">
                <thead>
                  <tr>
                    <th colspan="5">
                      <span class="ordertitle">{{record.createTime | dateFilter}}<span
                  ...
                  <tr v-for="(orderDetail,index) in record.orderDetailList" :key="orderDetail.id">
                    <td width="60%">
                      <div class="typographic">
                        <img :src="orderDetail.imgUrl" width="88">
                    ...
                    <td rowspan="2" width="13%" class="center">
                      <ul class="unstyled">
                        <li>总金额{{orderDetail.orderPrice}}</li>
                        <li>在线支付</li>
  ...
  export default {
    ...
    methods:{
      ...
      async mounted(){
            ...
            await this.getOrderInfo({page,limit})
        }
  }
</script>
